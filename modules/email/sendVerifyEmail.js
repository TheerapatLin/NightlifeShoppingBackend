            ...
            <style>
              ...
              .ExternalClass div {
                ...
                .btn-primary table td:hover {
                  background-color: #BD802C !important;
                }

                .btn-primary a:hover {
                  background-color: #BD802C !important;
                  border-color: #BD802C !important;
                }
              }
            </style>
          </head>
                                    ...
                                    <tr>
                                      <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;" valign="top">
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;">
                                          <tbody>
                                            <tr>
                                              <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; border-radius: 5px; text-align: center; background-color: #E97C00;" valign="top" align="center" bgcolor="#E97C00"> <a href="${text}" target="_blank" style="border: solid 1px #E97C00; border-radius: 5px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-decoration: none; text-transform: capitalize; background-color: #E97C00; border-color: #E97C00; color: #ffffff;">Verify</a> </td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </td>
